...
// BLUETOOTH
int xdesired = 0;                                         // variable for the desired x axis position of the ball
int ydesired = 0;                                         // variable for the desired y axis position of the ball
...
void getMessage(){
    ...
    if(c == 'X'){                                                           // if the first character received is x
        ...
        xdesired = atoi(xvalue);                                            // convert the character array into an integer
    }else if (c == 'Y'){                                                    // if the first character received is y
        ...
        ydesired = atoi(yvalue);                                            // convert the character array into an integer
        }
}
